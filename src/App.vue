<template>
  ...
  <div class="pagination_bar" v-if="count_products>max_products">
    <img class="arrow_pagination l" src="./assets/right-arrow.png" style="transform:rotate(180deg)" v-if="this_page>1">
    ...
    <img class="arrow_pagination" src="./assets/right-arrow.png" v-if="this_page<Math.ceil(count_products/max_products)">
  </div>
</template> 
<!-- @click="SelectCountry" -->
...
function SelectPage (){
  ...
  pagination_data.value = data.value.slice((this_page.value-1)*max_products,this_page.value*max_products)
}
